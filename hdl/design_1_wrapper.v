...
//Date        : Tue Jun  2 09:37:14 2026
//Host        : Hawk running 64-bit Ubuntu 24.04.4 LTS
...
module design_1_wrapper
   (DDC_0_scl_io,
    ...
    TMDS_1_data_p,
    sys_clk,
    hdmi_rx_hpd); // Added Hot Plug Detect External Port
  inout DDC_0_scl_io;
  inout DDC_0_sda_io;
  inout [14:0]DDR_addr;
  inout [2:0]DDR_ba;
  ...
  input sys_clk;
  output wire hdmi_rx_hpd; // Declared Hot Plug Detect Pin Direction
  ...
  // Assert HPD High to alert Ubuntu's display engine driver immediately
